...
import com.quhwa.adapter.SmartAreaRecycleAdapter;
import com.quhwa.bean.Advertisement;
import com.quhwa.presenter.SmartAreaPresenter;
...
public class SmartAreaFragment extends Fragment implements OnRefreshListener, ISmartAreaView {
    ...
    private SmartAreaFragment instance;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_smart_area, null);
