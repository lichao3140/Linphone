...
class LinphoneCoreImpl implements LinphoneCore {
	...
	private native Object inviteAddressWithParams(long nativePtrLc,long to, long nativePtrParam);//请求带参数的地址，拨打功能最终调用此方法
	...
	public synchronized void refreshRegisters() {
		android.util.Log.i("---正在注册---：nativePtr", nativePtr+"");
